...
class Router {
    ...
    renderHome() {
        // If we haven't navigated yet, we're on the initial page load
        // The home content is already in index.html, so do nothing
        if (!this.hasNavigated) {
            document.body.className = 'font-sans antialiased';
            return;
        }
        
        // If we've navigated away and are coming back to home,
        // reload the page to restore original home content
